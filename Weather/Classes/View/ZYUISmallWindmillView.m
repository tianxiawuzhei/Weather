...
static const CGFloat ZYUIBigWindmillViewWidth       = 44;
static const CGFloat ZYUIBigWindmillViewHeight      = 67;

@interface ZYUISmallWindmillView ()
@property (nonatomic, weak) CALayer * bladeLayer;
@end

@implementation ZYUISmallWindmillView
...
- (void)initializeUI
{
    ...
    CALayer *bladeLayer = ({
        ...
        UIImage *img = [UIImage imageNamed:@"blade_s"];
    ...
    CALayer *pole = ({
        CALayer *layer = [[CALayer alloc]init];
        UIImage *img = [UIImage imageNamed:@"smallpole"];
        layer.contents = (id)img.CGImage;
        layer.bounds= CGRectMake(0, 0, img.size.width, img.size.height);
